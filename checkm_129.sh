...
checkm lineage_wf --reduced_tree -t 4 -x fa /home/mariada/genome_analysis/DNA_trim/05_binning/bins_dir /home/mariada/genome_analysis/DNA_trim/06_checkm/checkm_129